...
if (isset($_GET["food-search"])) {
    $sql = "select * from food where fname like '%" . $_GET["food-search"] . "%' ";
    $stmt = $pdo->prepare($sql);
    $stmt->execute();
    $rows = $stmt->fetchAll();
    $pages = ceil(count($rows) / 12); //全部頁數
} else if (!isset($_GET["food-search"])) {
                        ...
                        <nav class="Page d-flex justify-content-center">
                            <ul class="pagination">
                               ...
                               <a class="page-link"> &lt; </a>
                                        ...
                                        echo '<li class="page-item">
                                <a class="page-link" href="?pgno=1&food-search=' . $_GET["food-search"] . '"> &lt;&lt; </a>
                                 </li>
                                <li class="page-item">
                                <a class="page-link" href="?pgno=' . $prevpage . '&food-search=' . $_GET["food-search"] . '"> &lt; </a>
                                 </li>';
                                    }
                                }
                                ?>
                                        ...
                                        for ($i = 1; $i <= $pages; $i++) {
                                            if ($pgno - 3 < $i && $i < $pgno + 3) {
                                                if ($i == $pgno) {
                                                    ...
                                                    echo '<li class="page-item"><a class="page-link" href="?pgno=' . $i . '&food-search=' . $_GET["food-search"] . '">' . $i . '</a></li>';
                                                }
                                            }
                                        }
                                    }
                                ...
                                if (!isset($_GET["food-search"])) {
                                  ...
                                  <li class="page-item">
                                    ...
                                    if ($pgno == $pages) {
                                        ...
                                        echo '<li class="page-item">
                                <a class="page-link" href="?pgno=' . $nextpage . '&food-search=' . $_GET["food-search"] . '"> &gt; </a>
                              </li>
                              <li class="page-item">
                                <a class="page-link" href="?pgno=' . $pages . '&food-search=' . $_GET["food-search"] . '"> &gt;&gt; </a>
                              </li>';
                                    }
                                }
                                ?>
