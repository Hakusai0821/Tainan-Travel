...
if (isset($_GET["area"])) {
    $sql = "select * from food where fdistrict like '%" . $_GET["area"] . "%' ";
            ...
            <form action="food.php" class="att-search w-100" method="get">
                ...
                <div class="dropdown d-flex align-items-center ms-2">
                    <div class="btn  btn-lg px-4 fs-4" type="button" id="areadropdown" data-bs-toggle="dropdown" style="background-color:  rgb(231, 156, 59); color:white; font-weight: 900;">
                        <?php echo $_GET["area"] ?> <i class="fa fa-filter fs-4 " aria-hidden="true"></i>
                    </div>
                        ...
                        <nav class="Page d-flex justify-content-center">
                            <ul class="pagination">
                               ...
                               <a class="page-link"> &lt; </a>
                                    ...
                                    echo '<li class="page-item">
                                <a class="page-link" href="?pgno=1&area=' . $_GET["area"] . '"> &lt;&lt; </a>
                                 </li>
                                <li class="page-item">
                                <a class="page-link" href="?pgno=' . $prevpage . '&area=' . $_GET["area"] . '"> &lt; </a>
                                 </li>';
                                }
                                ?>
                                <li class="page-item">
                                    ...
                                    for ($i = 1; $i <= $pages; $i++) {
                                        if ($pgno - 3 < $i && $i < $pgno + 3) {
                                            if ($i == $pgno) {
                                                ...
                                                echo '<li class="page-item"><a class="page-link" href="?pgno=' . $i . '&area=' . $_GET["area"] . '">' . $i . '</a></li>';
                                            }
                                        }
                                    }
                                ...
                                if ($pgno == $pages) {
                                    ...
                                    echo '<li class="page-item">
                                <a class="page-link" href="?pgno=' . $nextpage . '&area=' . $_GET["area"] . '"> &gt; </a>
                              </li>
                              <li class="page-item">
                                <a class="page-link" href="?pgno=' . $pages . '&area=' . $_GET["area"] . '"> &gt;&gt; </a>
                              </li>';
                                }
                                ?>
                            </ul>
